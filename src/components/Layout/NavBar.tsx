...
import { HomeIcon, ExternalLinkIcon, GearIcon, PersonIcon, Pencil2Icon } from "@radix-ui/react-icons";
import { FaPhone } from 'react-icons/fa';

function NavBar() {
    return (
        <Card className="rounded-none" >
            <CardContent className="flex flex-col items-center justify-center p-0  text-xl">
            <div className="flex justify-between items-center  w-full px-3">
            <div className="flex items-center justify-center gap-2 p-6">
                <img src={logo} alt="logo" className="w-10 h-10 " />
                <p>Burundi en Temps Réel</p>
                </div>
...
const MyIcon: React.FC<MyIconProps> = ({ width = 15, height = 15, ...props }) => {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      {...props} // Permet de passer des props supplémentaires, comme des styles ou des classes
    >
      <path
