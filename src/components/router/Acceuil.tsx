...
function Acceuil() {
  return (
    <main className="flex flex-col items-center justify-center w-full p-0">
       <div className="relative w-full h-[80vh]  max-sm:h-[50vh] max-[1025px]:h-[60vh]">
          <img src={profile} alt="profile" className="object-cover w-full h-full"/>
          <p className="absolute top-10 left-[50%] right-[50%] translate-x-[-50%] w-[90%] max-w-[600px] text-center text-outline italic text-white text-3xl font-[500] max-md:text-4xl max-sm:text-[1.2rem] max-lg:text-4xl max-[400px]:text-xl">Burundi en Temps Réel est une entreprise offrant des solutions web personnalisées, incluant la création de sites, le développement d'applications, l'optimisation, et l'hébergement web.
